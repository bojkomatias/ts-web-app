...
export const button = tv({
  ...
  variants: {
    ...
    outline: {
      true: ["border-line bg-popover text-foreground hover:bg-muted"],
    },
    solid: {
      true: ["border-transparent bg-popover text-foreground hover:bg-muted"],
    },
    ghost: {
      true: ["border-transparent bg-transparent hover:bg-popover"],
    },
  },
  defaultVariants: {
    outline: true,
