...
const colors = {
	...
	zinc: "bg-default-600/10 text-default-700 group-hover:bg-default-600/20 dark:bg-white/5 dark:text-default-400 dark:group-hover:bg-white/10",
}
...
export function Badge({
	...
	return (
		<span
			...
			class={clsx(
				props.class,
				"inline-flex items-center gap-x-1.5 rounded-lg px-1.5 py-0.5 font-medium text-sm/5 sm:text-xs/5 forced-colors:outline",
				colors[color],
			)}
		/>
	)
