	...
	return (
		<ArkDialog.Root {...props}>
			<Portal>
				<ArkDialog.Backdrop
					class={clsx(
						"fixed inset-0 z-20 flex w-screen justify-center overflow-y-auto px-2 py-2 lg:px-8 sm:px-6 lg:py-16 sm:py-8 focus:outline-0",
						// animation
				...
				<ArkDialog.Positioner
					class={clsx(
						...
						!drawer
							? "bottom-0 justify-center sm:top-24 sm:bottom-auto"
							: "inset-y-0",
					)}
				>
					{props.children}
	...
	return (
		<ArkDialog.Content
			class={clsx(
				props.class,
				sizes[size],
				"relative w-full rounded-xl rounded-b-none border border-popover bg-card p-8 shadow-lg sm:rounded-b-xl sm:p-6",
